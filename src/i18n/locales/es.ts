export const es = {
  ...
  donate: {
    ...
    tipTitle: "¿Quieres dejar un tip opcional?",
    tipDescription: "Apoya el desarrollo y crecimiento de la organización.",
    noTip: "Sin tip",
    tipPaymentTitle: "Método para el tip",
    tipPaymentHelp: "El tip se procesa por separado de tu donación.",
